                ...
                <section id="action-bar">
                            ...
                            <li>
                                ...
                                <ul>
                                    @foreach($catnav as $cat)
                                        <li>{{ HTML::link('/store/category/'.$cat->id, $cat->title) }}</li>
                                    @endforeach
                                </ul>
                            </li>
                        </ul>
                    ...
                    <div id="user-menu">
                        ...
                        <nav class="dropdown">
                            <ul>
                                <li>
                                    <a href="#"> {{ HTML::image('img/user-icon.gif', 'Andrew Perkins') }}Andrew Perkins <img src="img/down-arrow.gif" alt="Andrew Perkins" /></a>
                                    <ul>
